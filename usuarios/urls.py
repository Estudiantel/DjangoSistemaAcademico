...
urlpatterns = [
    ...
    path('docentes/', views.DocenteListView.as_view(), name='docente-list'),
    path('docentes/nuevo/', views.DocenteCreateView.as_view(), name='docente-create'),
    path('docentes/<int:pk>/editar/', views.DocenteUpdateView.as_view(), name='docente-update'),
    path('docentes/<int:pk>/eliminar/', views.DocenteDeleteView.as_view(), name='docente-delete'),
    ...
    path('mis-catedras/', views.MisMateriasDocenteView.as_view(), name='mis-catedras-docente'),
    path('mis-catedras/<int:pk>/alumnos/', views.MateriaAlumnosDocenteListView.as_view(), name='materia-alumnos-docente'),
